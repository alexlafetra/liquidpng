...
function LiquidDistortionSettings({settings,liquidPNGInstance}){
    ...
    const children = (
        ...
        {/* <LiquidCheckbox title = {"floating point distortion "} defaultState={settings.clampNoise} callback = {(val) => {settings.clampNoise = val;liquidPNGInstance.init();}}></LiquidCheckbox> */}
