<template>
    <div v-b-click-outside="closeDatePicker" :class="{disabled: disabled, 'b-resettable': canBeReset}" class="b-date">
        <b-input
        ...
        <b-popover :visible="visible">
            <b-date-picker :timestamp="timestamp" :visible="visible" @choose="choose" />
        </b-popover>
    </div>
</template>
