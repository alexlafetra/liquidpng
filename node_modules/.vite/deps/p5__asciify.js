import {
  p5
} from "./chunk-GA5QEQ3L.js";
import "./chunk-EXOAFPCI.js";
import "./chunk-PLDDJCW6.js";

// node_modules/p5.asciify/dist/p5.asciify.esm.js
var SA = Object.defineProperty;
var MA = (n, A, e) => A in n ? SA(n, A, { enumerable: true, configurable: true, writable: true, value: e }) : n[A] = e;
...
var VA = class {
  ...
  resizeGridDimensions(A, e) {
    this._fixedDimensions = true, [this._cols, this._rows] = [A, e], this._resizeGrid();
  }
  /**
   ...
   */
  resetGridDimensions() {
    this._fixedDimensions = false, this.reset();
  }
  /**
...
var j = (n) => {
  const A = [
    ...
    () => typeof p5 < "u" && p5.VERSION ? p5.VERSION : void 0,
...
var J = (n, A) => {
  var e;
  return A ? !!((e = n == null ? void 0 : n.constructor) != null && e.Color && A instanceof n.constructor.Color || typeof p5 < "u" && p5.Color && A instanceof p5.Color) : false;
};
var pA = (n, A) => {
  var e;
  return A ? !!((e = n == null ? void 0 : n.constructor) != null && e.Font && A instanceof n.constructor.Font || typeof p5 < "u" && p5.Font && A instanceof p5.Font) : false;
};
var O = (n, A) => {
...
var fA = ((n) => (n[n.SILENT = 0] = "SILENT", n[n.WARNING = 1] = "WARNING", n[n.ERROR = 2] = "ERROR", n[n.THROW = 3] = "THROW", n))(fA || {});
var T = class T2 {
  constructor() {
    o(this, "_options", {
      globalLevel: 3,
  ...
  static getInstance() {
    return T2._instance || (T2._instance = new T2()), T2._instance;
  }
  /**
  ...
  _handle(A, e, r) {
    switch (this._options.globalLevel, this._options.globalLevel) {
      ...
      case 1:
        return console.warn(`${this._options.consolePrefix} ${A}`, e), false;
      // Validation failed, warning logged
      case 2:
        return console.error(`${this._options.consolePrefix} ${A}`, e), false;
   ...
   */
  validate(A, e, r) {
    return A ? true : (this._handle(e, r), false);
  }
  /**
...
var HA = `precision mediump float;
...
var NA = `precision mediump float;
...
var xA = class {
  ...
  constructor(A, e, r, t, i) {
    ...
    o(this, "_hasEnabledRenderers", false);
    o(this, "_framebufferOptions");
   ...
   */
  render(A = "#000000") {
    this._characterFramebuffer.draw(() => this._p.clear()), this._primaryColorFramebuffer.draw(() => this._p.clear()), this._secondaryColorFramebuffer.draw(() => this._p.clear()), this._transformFramebuffer.draw(() => this._p.clear()), this._rotationFramebuffer.draw(() => this._p.clear()), this._hasEnabledRenderers = false;
   ...
   */
  enable() {
    this._renderers.forEach((A) => A.renderer.enabled(true));
  }
  /**
   ...
   */
  disable() {
    this._renderers.forEach((A) => A.renderer.enabled(false));
  }
  /**
...
var gA = class {
  ...
  constructor(A) {
    ...
    o(this, "_p");
    o(this, "_renderToCanvas", true);
    o(this, "_pluginRegistry");
    o(this, "_setupDone", false);
   ...
   * ```
   */
  font(A, e = { updateCharacters: true }) {
   ...
   */
  gridResponsive(A = true) {
    A ? this._grid.resetGridDimensions() : this._grid.fixedDimensions = true;
  }
  /**
    ...
    for (const B of e.cells)
      if (!(B.x < 0 || B.y < 0 || B.x >= a || B.y >= E)) {
        ...
        if (B.flipHorizontal !== void 0 || B.flipVertical !== void 0 || B.inverted !== void 0) {
          const C = B.inverted === true, f = B.flipHorizontal === true, b = B.flipVertical === true;
          _(d, B.x, B.y, [
            C ? 255 : 0,
            f ? 255 : 0,
            b ? 255 : 0,
...
var v = class v2 {
  constructor() {
    ...
    o(this, "p5AddonRegistered", false);
    o(this, "hookHandlers");
  ...
  static getInstance() {
    return v2._instance || (v2._instance = new v2()), v2._instance;
  }
  /**
  ...
  _registerCoreHooks() {
    ...
    this._registerHook("init", e, false);
    const r = function() {
   ...
   */
  _integrateWithP5() {
    if (typeof p5 > "u" || !p5 || !p5.VERSION) {
      console.log("p5.asciify loading without automatic hooks!");
      return;
    }
    O(p5.VERSION, "2.0.0") >= 0 && typeof p5.registerAddon == "function" ? this.p5AddonRegistered || (p5.registerAddon(this._createP5Addon()), this.p5AddonRegistered = true) : this._registerLegacyHooks();
  }
  /**
  ...
  _registerLegacyHooks() {
    this.registeredHooks.forEach((A, e) => {
      A.registered || (p5.prototype.registerMethod(e, A.proxyFn), A.registered = true);
    });
  }
  /**
...
var vA = class {
  ...
  register(A) {
    return !g.validate(
      ...
      { providedValue: A.id, method: "register" }
    ) ? false : (this._plugins.set(A.id, A), true);
  }
  /**
...
var k = class k2 {
   ...
   */
  static getInstance() {
    return k2._instance || (k2._instance = new k2()), k2._instance;
  }
  /**
  ...
  _applyShaderPrecisionFix() {
    ...
    const r = [
      ...
      () => typeof p5 < "u" && p5.RendererGL ? p5.RendererGL : void 0
    ];
    for (const t of r)
      try {
        const i = t();
...
//# sourceMappingURL=p5__asciify.js.map
